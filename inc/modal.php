	...
	<div class="modal-contents">
		...
		<div class="modal--inner">
			...
			<div class="info">
					...
					<div class="access">
						<dl>
							...
							<dd>
								〒471-0079<br/>
								豊田市陣中町1-6-11<br/>
								<span><a href="https://maps.app.goo.gl/y89rTWV8u2zLCL1t7" target="_blank">Googleマップで開く</a></span>
							</dd>
							<dd>
								【電車をご利用のお客様】<br/>
				...
				<div>
					<?php include('./inc/timetable.php')?>
					<a href="./yoyaku.php" class="b_yoyaku">診療の予約をする</a>
				</div>
			</div>
			</div>
		</div>
